...
const WelcomeBanner = () => (<div className="p-6 sm:p-8 bg-gradient-to-r from-blue-500 to-cyan-400 text-white rounded-xl mb-8 shadow-lg"><h2 className="text-3xl font-bold mb-2">ยินดีต้อนรับ!</h2><p className="text-lg opacity-90">เช่ารถได้ง่ายๆ ที่นี่</p></div>);
